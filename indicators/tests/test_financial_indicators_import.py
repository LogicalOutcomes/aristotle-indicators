...
from ..importers.financial_indicators import IndicatorImporter
...
class ImporterTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.spreadsheet = open(path_join(dirname(__file__), 'data/financial-indicators.xlsx'), 'r')
    ...
    def test_process(self):
        ...
        self.assertGreater(comet.Indicator.objects.count(), 2)
